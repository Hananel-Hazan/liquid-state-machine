...
namespace Liquid_Detector.Tests.TrentoKore.Parameters
{
	...
	/// </summary>
	[Serializable()]
	public class Input4TrentoKore : Input2liquid
	{
		public Input4TrentoKore()
		{
		...
		public Input4TrentoKore copy(){
			Input4TrentoKore source = (Input4TrentoKore) this.MemberwiseClone();
			return(source);
		}//----------------------------------------------------------------------------------
		...
		public Input4TrentoKore load(string args){
			Stream fileStream = new FileStream(args, FileMode.Open,FileAccess.Read, FileShare.None);
			BinaryFormatter binaryFormater = new BinaryFormatter();
			Input4TrentoKore Param = (Input4TrentoKore) binaryFormater.Deserialize(fileStream);
			fileStream.Close();
			return Param;
		}//----------------------------------------------------------------------------------
